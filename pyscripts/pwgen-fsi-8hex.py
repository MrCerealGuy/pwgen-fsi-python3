...
from common import header, wait_for_exit, formatted_password, print_copyright
...
print(Fore.CYAN + "Master Password Generator for FSI laptops (hexadecimal digits version)" + Style.RESET_ALL)
print("")
print_copyright()
print("")
